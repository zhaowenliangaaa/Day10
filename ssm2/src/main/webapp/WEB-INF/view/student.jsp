...
<body class="gray-bg">
	...
	<!-- 新增addd -->
	<div class="modal fade" id="modal_user_addd" role="dialog" aria-labelledby="modal_user_addd" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addd" method="post" action="adddStudent.htm">
